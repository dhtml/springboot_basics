 ...
 * It is a centralized place to handle errors — controllers
 * stay clean and do NOT need try-catch blocks.
 *
 * WITHOUT this class: Spring returns ugly HTML error pages or
 * raw stack traces. Clients see confusing, inconsistent errors.
 *
 * WITH this class: Every error is caught and formatted as a
 ...
 *   "When SomeException is thrown anywhere in any controller,
 *    call this method to handle it."
 *
 * Spring picks the MOST SPECIFIC handler. So:
 *   ResourceNotFoundException   → handleResourceNotFoundException()
 *   MethodArgumentNotValidException → handleValidationException()
 *   Any other exception         → handleGenericException() (catch-all)
 */
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleValidationErrors(
        ...
        // Extract all field-level validation errors into a map: fieldName → errorMessage
